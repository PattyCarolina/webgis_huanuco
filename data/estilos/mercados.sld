    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Stroke>
                  <se:SvgParameter name="stroke">#e8de17</se:SvgParameter>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>hexagon</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#fafb7c</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
                  <se:SvgParameter name="stroke">#b19433</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:MaxScaleDenominator>32500</se:MaxScaleDenominator>
          <se:TextSymbolizer>
            <se:Label>
